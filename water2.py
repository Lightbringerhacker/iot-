...
step=water_jug_fill_any_jug(m,n,d)
if step:
    print(f"it is possible to measure exactly {d} litter in one of jug.step:")

    for i,step in enumerate(step):
            print(f"step {i+1}: jug 1={step[0]} liter,jug2={step[1]} liters")
