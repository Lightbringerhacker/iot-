...
class PuzzleState:
    ...
    # This is the method for comparing two PuzzleState objects by their cost
    def __lt__(self, other):
        return self.cost < other.cost

def a_star(initial_board):
    initial_zero_pos = tuple(np.argwhere(initial_board == 0)[0])  # Get the position of zero
    ...
    while priority_queue:
        ...
        visited.add(tuple(map(tuple, current_state.board)))  # Add the board as a tuple of tuples to the visited set
